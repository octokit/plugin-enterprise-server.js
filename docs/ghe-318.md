...
octokit.enterpriseAdmin.deleteManageSsh({ key, origin });
...
octokit.enterpriseAdmin.initializeInstanceConfiguration({
  license,
  password,
  origin,
});
...
octokit.enterpriseAdmin.licenseUpload({ apply, license, origin });
...
octokit.enterpriseAdmin.setAnnouncement({
  announcement,
  expires_at,
  user_dismissible,
});
...
octokit.enterpriseAdmin.setManageSettings({ origin });
octokit.enterpriseAdmin.setManageSsh({ key, origin });
...
octokit.codeSecurity.attachEnterpriseConfiguration({
  enterprise,
  configuration_id,
  scope,
});
...
octokit.codeSecurity.createConfigurationForEnterprise({
  enterprise,
  name,
  description,
  advanced_security,
...
octokit.codeSecurity.deleteConfigurationForEnterprise({
  enterprise,
  configuration_id,
});
...
octokit.codeSecurity.getConfigurationsForEnterprise({
  enterprise,
  per_page,
  before,
  after,
...
octokit.codeSecurity.getDefaultConfigurationsForEnterprise({ enterprise });
...
octokit.codeSecurity.getRepositoriesForEnterpriseConfiguration({
  enterprise,
  configuration_id,
  per_page,
  before,
...
octokit.codeSecurity.getSingleConfigurationForEnterprise({
  enterprise,
  configuration_id,
});
...
octokit.codeSecurity.setConfigurationAsDefaultForEnterprise({
  enterprise,
  configuration_id,
  default_for_new_repos,
});
...
octokit.codeSecurity.updateEnterpriseConfiguration({
  enterprise,
  configuration_id,
  name,
  description,
...
octokit.credentials.revoke({ credentials });
...
octokit.dependabot.repositoryAccessForOrg({ org, page, per_page });
octokit.dependabot.setRepositoryAccessDefaultLevel({ org, default_level });
...
octokit.dependabot.updateRepositoryAccessForOrg({
  org,
...
octokit.privateRegistries.createOrgPrivateRegistry({
  org,
  registry_type,
  url,
  username,
...
octokit.privateRegistries.deleteOrgPrivateRegistry({ org, secret_name });
octokit.privateRegistries.getOrgPrivateRegistry({ org, secret_name });
octokit.privateRegistries.getOrgPublicKey({ org });
octokit.privateRegistries.listOrgPrivateRegistries({ org, per_page, page });
octokit.privateRegistries.updateOrgPrivateRegistry({
  org,
  secret_name,
  registry_type,
  url,
...
octokit.secretScanning.getAlert({ owner, repo, alert_number, hide_secret });
octokit.secretScanning.getScanHistory({ owner, repo });
