...
const Endpoints: EndpointsDefaultsAndDecorations = {
  ...
  apps: {
    ...
    checkAuthorization: [
      ...
      {
        deprecated:
          "octokit.scim.checkAuthorization() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#check-an-authorization",
      },
    ],
    ...
    resetAuthorization: [
      ...
      {
        deprecated:
          "octokit.scim.resetAuthorization() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#reset-an-authorization",
      },
    ],
    ...
    revokeAuthorizationForApplication: [
      ...
      {
        deprecated:
          "octokit.scim.revokeAuthorizationForApplication() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#revoke-an-authorization-for-an-application",
      },
    ],
    revokeGrantForApplication: [
      ...
      {
        deprecated:
          "octokit.scim.revokeGrantForApplication() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#revoke-a-grant-for-an-application",
      },
    ],
  ...
  teams: {
    addMemberLegacy: [
      ...
      {
        deprecated:
          "octokit.scim.addMemberLegacy() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/teams#add-team-member-legacy",
      },
    ],
    ...
    getMemberLegacy: [
      ...
      {
        deprecated:
          "octokit.scim.getMemberLegacy() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/teams#get-team-member-legacy",
      },
    ],
    ...
    removeMemberLegacy: [
      ...
      {
        deprecated:
          "octokit.scim.removeMemberLegacy() is deprecated, see https://docs.github.com/enterprise-server@2.20/rest/reference/teams#remove-team-member-legacy",
      },
    ],
