...
octokit.issues.addAssignees(assignees, issue_number, number, owner, repo)
octokit.issues.addLabels(issue_number, labels, number, owner, repo)
...
octokit.issues.createComment(body, issue_number, number, owner, repo)
...
octokit.issues.deleteMilestone(milestone_number, number, owner, repo)
octokit.issues.get(issue_number, number, owner, repo)
...
octokit.issues.getMilestone(milestone_number, number, owner, repo)
...
octokit.issues.listComments(issue_number, number, owner, page, per_page, repo, since)
octokit.issues.listCommentsForRepo(direction, owner, repo, since, sort)
octokit.issues.listEvents(issue_number, number, owner, page, per_page, repo)
octokit.issues.listEventsForRepo(owner, page, per_page, repo)
octokit.issues.listEventsForTimeline(issue_number, number, owner, page, per_page, repo)
...
octokit.issues.listLabelsForMilestone(milestone_number, number, owner, page, per_page, repo)
octokit.issues.listLabelsForRepo(owner, page, per_page, repo)
octokit.issues.listLabelsOnIssue(issue_number, number, owner, page, per_page, repo)
octokit.issues.listMilestonesForRepo(direction, owner, page, per_page, repo, sort, state)
octokit.issues.lock(issue_number, lock_reason, number, owner, repo)
octokit.issues.removeAssignees(assignees, issue_number, number, owner, repo)
octokit.issues.removeLabel(issue_number, name, number, owner, repo)
octokit.issues.removeLabels(issue_number, number, owner, repo)
octokit.issues.replaceLabels(issue_number, labels, number, owner, repo)
octokit.issues.unlock(issue_number, number, owner, repo)
octokit.issues.update(assignee, assignees, body, issue_number, labels, milestone, number, owner, repo, state, title)
...
octokit.issues.updateMilestone(description, due_on, milestone_number, number, owner, repo, state, title)
...
octokit.pulls.checkIfMerged(number, owner, pull_number, repo)
octokit.pulls.create(base, body, head, maintainer_can_modify, owner, repo, title)
octokit.pulls.createComment(body, commit_id, number, owner, path, position, pull_number, repo)
octokit.pulls.createCommentReply(body, in_reply_to, number, owner, pull_number, repo)
octokit.pulls.createFromIssue(base, head, issue, maintainer_can_modify, owner, repo)
octokit.pulls.createReview(body, comments, commit_id, event, number, owner, pull_number, repo)
octokit.pulls.createReviewRequest(number, owner, pull_number, repo, reviewers, team_reviewers)
octokit.pulls.deleteComment(comment_id, owner, repo)
octokit.pulls.deletePendingReview(number, owner, pull_number, repo, review_id)
octokit.pulls.deleteReviewRequest(number, owner, pull_number, repo, reviewers, team_reviewers)
octokit.pulls.dismissReview(message, number, owner, pull_number, repo, review_id)
octokit.pulls.get(number, owner, pull_number, repo)
octokit.pulls.getComment(comment_id, owner, repo)
octokit.pulls.getCommentsForReview(number, owner, page, per_page, pull_number, repo, review_id)
octokit.pulls.getReview(number, owner, pull_number, repo, review_id)
octokit.pulls.list(base, direction, head, owner, page, per_page, repo, sort, state)
octokit.pulls.listComments(direction, number, owner, page, per_page, pull_number, repo, since, sort)
octokit.pulls.listCommentsForRepo(direction, owner, page, per_page, repo, since, sort)
octokit.pulls.listCommits(number, owner, page, per_page, pull_number, repo)
octokit.pulls.listFiles(number, owner, page, per_page, pull_number, repo)
octokit.pulls.listReviewRequests(number, owner, page, per_page, pull_number, repo)
octokit.pulls.listReviews(number, owner, page, per_page, pull_number, repo)
octokit.pulls.merge(commit_message, commit_title, merge_method, number, owner, pull_number, repo, sha)
octokit.pulls.submitReview(body, event, number, owner, pull_number, repo, review_id)
octokit.pulls.update(base, body, maintainer_can_modify, number, owner, pull_number, repo, state, title)
...
octokit.reactions.createForIssue(content, issue_number, number, owner, repo)
...
octokit.reactions.listForIssue(content, issue_number, number, owner, page, per_page, repo)
...
octokit.repos.getCommit(commit_sha, owner, repo, sha)
